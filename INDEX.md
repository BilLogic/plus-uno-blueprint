...
| docs/guidelines/foundations/color.md | designers | The four color-token tiers, semantic-only consumption, dark mode as a class, the forced-colors stance, lane tints, the annotation chrome ink ladder, and the agent-ink precedent. |
