-- Goal Setting — onboarding module links on every Regular Tutor cell (all paths)
...
from (
  select jsonb_build_array(
    jsonb_build_object(
      'type', 'url',
      'label', 'PLUS Onboarding Module 9',
      'url', 'https://app.tutors.plus/PLUS/Resource?resourceId=313'
    ),
    jsonb_build_object(
      'type', 'url',
