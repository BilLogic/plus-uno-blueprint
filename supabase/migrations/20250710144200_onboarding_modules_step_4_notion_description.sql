-- Onboarding Modules step 4: update Notion Front Stage Tech description.
    ...
    case
      when link->>'type' = 'tech_description' and link->>'label' = 'Notion'
        then jsonb_set(
          ...
          '{description}',
          to_jsonb(
            'The tutor reviews supplementary materials linked from the Notion module content.'::text
          )
        )
      else link
    end
