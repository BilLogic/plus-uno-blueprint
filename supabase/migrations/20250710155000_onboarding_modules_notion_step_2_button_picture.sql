-- Onboarding Modules Happy Path — Notion step 2 open-module button screenshot
...
set links = jsonb_build_array(
  ...
  jsonb_build_object(
    ...
    'picture', '/blueprint-images/onboarding-modules/happy-path/notion/step-02-open-module-button.png'
  )
)
