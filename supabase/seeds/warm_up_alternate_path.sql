...
-- Clone cells except step 3 (…0313)
...
-- Remove triggers that referenced step 3 cells or the happy-path 2→3 / 3→4 hops
...
-- Clone remaining triggers (…05xxxx → …07xxxx), skipping happy-path step-3 hops
...
-- Regular Tutor: step 2 → step 4 (…0314), skipping step 3
insert into public.cell_triggers (id, source_cell_id, target_cell_id)
values (
  'a0000000-0000-4000-8000-000000070102',
