  ...
  return (
    ...
    >
      ...
      <Button
        ...
        onClick={onResetView}
        className="pointer-events-auto h-8 shrink-0 gap-1.5 rounded-lg border-border bg-card px-3 font-medium text-muted-foreground shadow-md hover:text-foreground hover:shadow-lg"
      >
