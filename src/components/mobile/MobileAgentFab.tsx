 ...
 * right above the safe-area inset — not a top-bar icon, which read as one
 * more chrome glyph. Hidden entirely for read-only tiers (the same rule as
 * everywhere else in the chrome: viewers get no agent affordance). The
 * sheet it opens covers it, so it needs no open/close state of its own.
 */
