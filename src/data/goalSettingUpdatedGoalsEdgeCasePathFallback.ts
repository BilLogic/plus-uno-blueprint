...
import {
  ...
  GOAL_SETTING_UPDATE_GOALS_EDGE_CASE_REGULAR_TUTOR_STEP_01_FRAME,
  GOAL_SETTING_UPDATE_GOALS_EDGE_CASE_REGULAR_TUTOR_STEP_02_FRAME,
  GOAL_SETTING_UPDATE_GOALS_EDGE_CASE_REGULAR_TUTOR_STEP_03_FRAME,
  GOAL_SETTING_UPDATE_GOALS_EDGE_CASE_REGULAR_TUTOR_STEP_04_FRAME,
  GOAL_SETTING_UPDATE_GOALS_EDGE_CASE_REGULAR_TUTOR_STEP_05_FRAME,
  GOAL_SETTING_UPDATE_GOALS_EDGE_CASE_REGULAR_TUTOR_STEP_06_FRAME,
  GOAL_SETTING_UPDATE_GOALS_EDGE_CASE_REGULAR_TUTOR_STEP_07_FRAME,
  GOAL_SETTING_UPDATE_GOALS_EDGE_CASE_REGULAR_TUTOR_STEP_08_FRAME,
  GOAL_SETTING_UPDATE_GOALS_EDGE_CASE_REGULAR_TUTOR_STEP_09_FRAME,
  GOAL_SETTING_UPDATE_GOALS_EDGE_CASE_REGULAR_TUTOR_STEP_10_FRAME,
  GOAL_SETTING_UPDATE_GOALS_EDGE_CASE_REGULAR_TUTOR_STEP_11_FRAME,
  GOAL_SETTING_UPDATE_GOALS_EDGE_CASE_REGULAR_TUTOR_STEP_12_FRAME,
  GOAL_SETTING_UPDATE_GOALS_EDGE_CASE_PLUS_APP_STEP_02_FRAME,
  GOAL_SETTING_UPDATE_GOALS_EDGE_CASE_PLUS_APP_STEP_03_FRAME,
  GOAL_SETTING_UPDATE_GOALS_EDGE_CASE_PLUS_APP_STEP_04_FRAME,
  GOAL_SETTING_UPDATE_GOALS_EDGE_CASE_PLUS_APP_STEP_05_FRAME,
  GOAL_SETTING_UPDATE_GOALS_EDGE_CASE_PLUS_APP_STEP_06_FRAME,
  GOAL_SETTING_UPDATE_GOALS_EDGE_CASE_PLUS_APP_STEP_07_FRAME,
  GOAL_SETTING_UPDATE_GOALS_EDGE_CASE_PLUS_APP_STEP_08_FRAME,
  GOAL_SETTING_UPDATE_GOALS_EDGE_CASE_PLUS_APP_STEP_09_FRAME,
  GOAL_SETTING_UPDATE_GOALS_EDGE_CASE_PLUS_APP_STEP_10_FRAME,
  GOAL_SETTING_UPDATE_GOALS_EDGE_CASE_PLUS_APP_STEP_12_FRAME,
...
const STEP_STORYBOARD_LANE_ID = 'a0000000-0000-4000-8000-0000000008f0'
...
const GOAL_SETTING_UPDATED_GOALS_EDGE_CASE_CELLS: BlueprintCell[] = [
  ...
  cell(ugCell('01', '03'), L.regular, STEPS[0].id, 'Join breakout session.', {
    frame: GOAL_SETTING_UPDATE_GOALS_EDGE_CASE_REGULAR_TUTOR_STEP_01_FRAME,
  }),
  cell(
    ugCell('02', '03'),
    L.regular,
    ...
    { frame: GOAL_SETTING_UPDATE_GOALS_EDGE_CASE_REGULAR_TUTOR_STEP_02_FRAME },
  ),
  cell(
    ugCell('03', '03'),
    L.regular,
    ...
    { frame: GOAL_SETTING_UPDATE_GOALS_EDGE_CASE_REGULAR_TUTOR_STEP_03_FRAME },
  ),
  cell(ugCell('04', '03'), L.regular, STEPS[3].id, 'Share screen.', {
    frame: GOAL_SETTING_UPDATE_GOALS_EDGE_CASE_REGULAR_TUTOR_STEP_04_FRAME,
  }),
  cell(
    ugCell('05', '03'),
    L.regular,
    ...
    { frame: GOAL_SETTING_UPDATE_GOALS_EDGE_CASE_REGULAR_TUTOR_STEP_05_FRAME },
  ),
  cell(
    ugCell('06', '03'),
    L.regular,
    ...
    { frame: GOAL_SETTING_UPDATE_GOALS_EDGE_CASE_REGULAR_TUTOR_STEP_06_FRAME },
  ),
  cell(
    ugCell('07', '03'),
    L.regular,
    ...
    { frame: GOAL_SETTING_UPDATE_GOALS_EDGE_CASE_REGULAR_TUTOR_STEP_07_FRAME },
  ),
  cell(
    ugCell('08', '03'),
    L.regular,
    ...
    { frame: GOAL_SETTING_UPDATE_GOALS_EDGE_CASE_REGULAR_TUTOR_STEP_08_FRAME },
  ),
  cell(ugCell('09', '03'), L.regular, STEPS[8].id, 'Save goal.', {
    frame: GOAL_SETTING_UPDATE_GOALS_EDGE_CASE_REGULAR_TUTOR_STEP_09_FRAME,
  }),
  cell(
    ugCell('10', '03'),
    L.regular,
    ...
    { frame: GOAL_SETTING_UPDATE_GOALS_EDGE_CASE_REGULAR_TUTOR_STEP_10_FRAME },
  ),
  cell(ugCell('11', '03'), L.regular, STEPS[10].id, 'Leave breakout room.', {
    frame: GOAL_SETTING_UPDATE_GOALS_EDGE_CASE_REGULAR_TUTOR_STEP_11_FRAME,
  }),
  cell(
    ugCell('12', '03'),
    L.regular,
    ...
    { frame: GOAL_SETTING_UPDATE_GOALS_EDGE_CASE_REGULAR_TUTOR_STEP_12_FRAME },
  ),
