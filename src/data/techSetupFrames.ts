...
export const TECH_SETUP_EMAIL_STEP_01_DESCRIPTION =
  'The tutor receives an email from the tutor supervisor team with instructions and links for completing required tutor clearances.'

/** Tech Setup — Front Stage Tech step 2 (Obtain clearances). */
export const TECH_SETUP_CLEARANCE_GUIDE_STEP_02_DESCRIPTION =
  'The tutor follows the clearance obtainment guide to complete required background checks and certifications through CMU HR.'

/** Tech Setup — Front Stage Tech step 3 (Send clearances). */
export const TECH_SETUP_EMAIL_STEP_03_DESCRIPTION =
  'The tutor emails completed clearance documents to the tutor supervisor team for review.'

/** Tech Setup — Front Stage Tech step 4 (I-9 meeting). */
export const TECH_SETUP_WORKDAY_STEP_04_DESCRIPTION =
  'The tutor schedules an I-9 meeting with CMU HR through Workday.'

/** Tech Setup — Front Stage Tech step 6 (Payroll setup — employee view). */
export const TECH_SETUP_WORKDAY_EMPLOYEE_STEP_06_DESCRIPTION =
  'The tutor completes payroll onboarding tasks in Workday, including entering personal and employment information.'

/** Tech Setup — Back Stage Tech step 6 (Payroll setup — employer view). */
export const TECH_SETUP_WORKDAY_EMPLOYER_STEP_06_DESCRIPTION =
  'The PLUS supervisor team completes corresponding student employment paperwork in Workday on the employer side.'

/** Tech Setup — Front Stage Tech step 7 (Join Slack). */
export const TECH_SETUP_EMAIL_STEP_07_DESCRIPTION =
  'The tutor receives an email invitation to join the PLUS tutor Slack workspace.'

export const TECH_SETUP_SLACK_STEP_07_DESCRIPTION =
  'The tutor accepts the Slack invite and joins the PLUS tutor channel to connect with the tutoring team.'

/** Tech Setup — Front Stage Tech step 8 (PLUS app login). */
export const TECH_SETUP_EMAIL_STEP_08_DESCRIPTION =
  'The tutor receives an email from the PLUS supervisor team with PLUS app login credentials and setup instructions.'
...
export const TECH_SETUP_CHILD_PROTECTION_LAWS_DESCRIPTION =
  'Child protection laws require PLUS tutors to complete mandated background checks and clearances before working with students.'

/** Tech Setup — Support Actions steps 4–5 (I-9 steps). */
export const TECH_SETUP_EMPLOYMENT_LAWS_DESCRIPTION =
  'Employment laws identity and employment eligibility verification upon hiring.'
