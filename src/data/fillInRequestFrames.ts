...
export const FILL_IN_REQUEST_SHIFT_SWAP_FORM_STEP_01_DESCRIPTION =
  'The call-off request is initiated through the Shift Swap Google Form, which lets the tutor supervisor team know they need to find coverage for that session.'

/** Step 1 — Back Stage Tech. */
...
export const FILL_IN_REQUEST_SLACK_STEP_02_DESCRIPTION =
  'The fill-in request is shared in the #shift-swap Slack channel so available tutors can see it.'

export const FILL_IN_REQUEST_EMAIL_STEP_02_DESCRIPTION =
  'The tutor supervisor team can also send the fill-in request to tutors by email.'

/** Step 3 — Front Stage Tech. */
export const FILL_IN_REQUEST_SLACK_STEP_03_DESCRIPTION =
  'The tutor confirms or denies the fill-in request through Slack.'

export const FILL_IN_REQUEST_EMAIL_STEP_03_DESCRIPTION =
  'The tutor can also confirm or deny the fill-in request by email.'

/** Step 4 — Front Stage Tech. */
