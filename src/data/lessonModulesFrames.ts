...
/** Notion logo for Lesson Modules Back Stage Tech cells. */
...
export const LESSON_MODULES_NOTION_STEP_02_DESCRIPTION =
  'The instructional design team uses Notion to design and maintain the lesson content.'

/** Lesson Modules — Front Stage Tech step 3 (Finish lesson). */
...
/** Lesson Modules — Support Actions (Researchers). */
export const LESSON_MODULES_RESEARCHERS_SUPPORT_DESCRIPTION =
  'Researchers help guide how lesson content is designed and delivered so tutors learn effectively.'

/** Lesson Modules — Support Actions (Dev Team / Design Team). */
export const LESSON_MODULES_DEV_DESIGN_SUPPORT_DESCRIPTION =
...
/** Lesson Modules — Support Actions steps 1–2 (Researchers + Dev/Design). */
export const LESSON_MODULES_STEPS_01_02_SUPPORT_DESCRIPTION = `${LESSON_MODULES_RESEARCHERS_SUPPORT_DESCRIPTION}\n\n${LESSON_MODULES_DEV_DESIGN_SUPPORT_DESCRIPTION}`
