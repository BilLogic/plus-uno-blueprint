...
import {
  ...
  GOAL_SETTING_UPDATE_GOALS_REGULAR_TUTOR_STEP_01_FRAME,
  GOAL_SETTING_UPDATE_GOALS_REGULAR_TUTOR_STEP_02_FRAME,
  GOAL_SETTING_UPDATE_GOALS_REGULAR_TUTOR_STEP_03_FRAME,
  GOAL_SETTING_UPDATE_GOALS_REGULAR_TUTOR_STEP_04_FRAME,
  GOAL_SETTING_UPDATE_GOALS_REGULAR_TUTOR_STEP_05_FRAME,
  GOAL_SETTING_UPDATE_GOALS_REGULAR_TUTOR_STEP_06_FRAME,
  GOAL_SETTING_UPDATE_GOALS_REGULAR_TUTOR_STEP_07_FRAME,
  GOAL_SETTING_UPDATE_GOALS_REGULAR_TUTOR_STEP_08_FRAME,
  GOAL_SETTING_UPDATE_GOALS_REGULAR_TUTOR_STEP_09_FRAME,
  GOAL_SETTING_UPDATE_GOALS_REGULAR_TUTOR_STEP_10_FRAME,
  GOAL_SETTING_UPDATE_GOALS_REGULAR_TUTOR_STEP_11_FRAME,
  GOAL_SETTING_UPDATE_GOALS_PLUS_APP_STEP_02_FRAME,
  GOAL_SETTING_UPDATE_GOALS_PLUS_APP_STEP_03_FRAME,
  GOAL_SETTING_UPDATE_GOALS_PLUS_APP_STEP_05_FRAME,
  GOAL_SETTING_UPDATE_GOALS_PLUS_APP_STEP_06_FRAME,
  GOAL_SETTING_UPDATE_GOALS_PLUS_APP_STEP_07_FRAME,
  GOAL_SETTING_UPDATE_GOALS_PLUS_APP_STEP_08_FRAME,
  GOAL_SETTING_UPDATE_GOALS_PLUS_APP_STEP_09_FRAME,
  GOAL_SETTING_UPDATE_GOALS_PLUS_APP_STEP_11_FRAME,
...
const STEP_STORYBOARD_LANE_ID = 'a0000000-0000-4000-8000-0000000008d0'
...
const GOAL_SETTING_UPDATE_GOALS_ZOOM_STEP_01_DESCRIPTION =
  'The tutor connects with student via Zoom in individual breakout room.'

const GOAL_SETTING_UPDATE_GOALS_ZOOM_STEP_03_DESCRIPTION =
  'The tutor shares screen via Zoom screen share feature.'

const GOAL_SETTING_UPDATE_GOALS_ZOOM_STEP_04_DESCRIPTION =
  'The tutor connects with student via Zoom in individual breakout room.'

const GOAL_SETTING_UPDATE_GOALS_ZOOM_STEP_05_DESCRIPTION =
  'The tutor connects with student via Zoom in individual breakout room.'

const GOAL_SETTING_UPDATE_GOALS_ZOOM_STEP_06_DESCRIPTION =
  'The tutor connects with student via Zoom in individual breakout room.'

const GOAL_SETTING_UPDATE_GOALS_ZOOM_STEP_07_DESCRIPTION =
  'The tutor connects with student via Zoom in individual breakout room.'

const GOAL_SETTING_UPDATE_GOALS_ZOOM_STEP_08_DESCRIPTION =
  'The tutor connects with student via Zoom in individual breakout room.'

const GOAL_SETTING_UPDATE_GOALS_ZOOM_STEP_09_DESCRIPTION =
  'The tutor connects with student via Zoom in individual breakout room.'

const GOAL_SETTING_UPDATE_GOALS_ZOOM_STEP_10_DESCRIPTION =
...
function guDependency(dependencySlot: string): string {
  return `a0000000-0000-4000-8000-00000009e${dependencySlot}`
}
...
const GOAL_SETTING_UPDATE_GOALS_TRIGGERS: BlueprintCellDependency[] = [
...
const GOAL_SETTING_UPDATE_GOALS_CELLS: BlueprintCell[] = [
  ...
  cell(guCell('01', '03'), L.regular, STEPS[0].id, 'Join breakout session.', {
    frame: GOAL_SETTING_UPDATE_GOALS_REGULAR_TUTOR_STEP_01_FRAME,
  }),
  cell(
    guCell('02', '03'),
    L.regular,
    ...
    { frame: GOAL_SETTING_UPDATE_GOALS_REGULAR_TUTOR_STEP_02_FRAME },
  ),
  cell(guCell('03', '03'), L.regular, STEPS[2].id, 'Share screen.', {
    frame: GOAL_SETTING_UPDATE_GOALS_REGULAR_TUTOR_STEP_03_FRAME,
  }),
  cell(
    guCell('04', '03'),
    L.regular,
    ...
    { frame: GOAL_SETTING_UPDATE_GOALS_REGULAR_TUTOR_STEP_04_FRAME },
  ),
  cell(
    guCell('05', '03'),
    L.regular,
    ...
    { frame: GOAL_SETTING_UPDATE_GOALS_REGULAR_TUTOR_STEP_05_FRAME },
  ),
  cell(
    guCell('06', '03'),
    L.regular,
    ...
    { frame: GOAL_SETTING_UPDATE_GOALS_REGULAR_TUTOR_STEP_06_FRAME },
  ),
  cell(
    guCell('07', '03'),
    L.regular,
    ...
    { frame: GOAL_SETTING_UPDATE_GOALS_REGULAR_TUTOR_STEP_07_FRAME },
  ),
  cell(guCell('08', '03'), L.regular, STEPS[7].id, 'Save goal.', {
    frame: GOAL_SETTING_UPDATE_GOALS_REGULAR_TUTOR_STEP_08_FRAME,
  }),
  cell(
    guCell('09', '03'),
    L.regular,
    ...
    { frame: GOAL_SETTING_UPDATE_GOALS_REGULAR_TUTOR_STEP_09_FRAME },
  ),
  cell(guCell('10', '03'), L.regular, STEPS[9].id, 'Leave breakout room.', {
    frame: GOAL_SETTING_UPDATE_GOALS_REGULAR_TUTOR_STEP_10_FRAME,
  }),
  cell(
    guCell('11', '03'),
    L.regular,
    ...
    { frame: GOAL_SETTING_UPDATE_GOALS_REGULAR_TUTOR_STEP_11_FRAME },
  ),

  cell(guCell('01', '06'), L.frontStageTech, STEPS[0].id, 'Zoom', {
    summary: GOAL_SETTING_UPDATE_GOALS_ZOOM_STEP_01_DESCRIPTION,
  }),
  ...
  cell(
    ...
    'Zoom, PLUS App',
    {
      summary: GOAL_SETTING_UPDATE_GOALS_ZOOM_STEP_03_DESCRIPTION,
      links: [
        updateGoalsPlusAppLink(
  ...
  cell(guCell('04', '06'), L.frontStageTech, STEPS[3].id, 'Zoom', {
    summary: GOAL_SETTING_UPDATE_GOALS_ZOOM_STEP_04_DESCRIPTION,
  }),
  cell(
    guCell('05', '06'),
    L.frontStageTech,
    ...
    'Zoom, PLUS App',
    {
      summary: GOAL_SETTING_UPDATE_GOALS_ZOOM_STEP_05_DESCRIPTION,
      links: [
        updateGoalsPlusAppLink(
  ...
  cell(
    ...
    'Zoom, PLUS App',
    {
      summary: GOAL_SETTING_UPDATE_GOALS_ZOOM_STEP_06_DESCRIPTION,
      links: [
        updateGoalsPlusAppLink(
  ...
  cell(
    ...
    'Zoom, PLUS App',
    {
      summary: GOAL_SETTING_UPDATE_GOALS_ZOOM_STEP_07_DESCRIPTION,
      links: [
        updateGoalsPlusAppLink(
  ...
  cell(
    ...
    'Zoom, PLUS App',
    {
      summary: GOAL_SETTING_UPDATE_GOALS_ZOOM_STEP_08_DESCRIPTION,
      links: [
        updateGoalsPlusAppLink(
  ...
  cell(
    ...
    'Zoom, PLUS App',
    {
      summary: GOAL_SETTING_UPDATE_GOALS_ZOOM_STEP_09_DESCRIPTION,
      links: [
        updateGoalsPlusAppLink(
  ...
  cell(guCell('10', '06'), L.frontStageTech, STEPS[9].id, 'Zoom', {
    summary: GOAL_SETTING_UPDATE_GOALS_ZOOM_STEP_10_DESCRIPTION,
  }),
