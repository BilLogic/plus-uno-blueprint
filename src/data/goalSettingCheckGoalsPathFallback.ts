...
function gcCell(stepSlot: string, laneSuffix: string): string {
  return `a0000000-0000-4000-8000-000000a0${stepSlot}${laneSuffix}`
}
...
function dependency(
  ...
  return {
    ...
    source_cell_id: gcCell(fromStep, fromLane),
    target_cell_id: gcCell(toStep, toLane),
  }
}
