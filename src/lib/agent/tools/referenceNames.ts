 ...
 * canvas adapter, both empty in the standalone kit.
 *
 ...
 * agreement. A registered key the kit already serves is an override of that
 ...
 * OVERRIDE of a document this kit already serves rather than an addition —
