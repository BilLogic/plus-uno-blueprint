...
applies to the mapping, not just to new columns. In the proposed
outline, tag each cell with the note fragment it comes from (a short
quote in parentheses) — a cell you cannot tag is a cell you are
