...
| design/foundations/data-viz.md | designers | The encodings — compare bands, ledger, divergence strip and zones, severity, the semantic-zoom blocks tier, path-type colors — and the rule that every encoding is tokenized and survives dark + forced-colors. |
